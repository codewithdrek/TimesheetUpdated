            ...
            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 bhoechie-tab-menu">
              <div class="list-group">
                <a href="#" class="list-group-item active text-center">
                  <h4 class="glyphicon glyphicon-user"></h4><br/>Basic Detail
                </a>
                <a href="#" class="list-group-item text-center">
                  <h4 class="glyphicon glyphicon-road"></h4><br/>Contact Information
                </a>
                <a href="#" class="list-group-item text-center">
                  <h4 class="glyphicon glyphicon-tasks"></h4><br/>Current Work Information
                </a>
                <a href="#" class="list-group-item text-center">
        ...
        <div class="col-sm-12">
        				<div class="row">
        					<div class="col-sm-4 form-group">
								...
								<br><span><b>${employeeBean.userCode}</b></span>
								<form:hidden path="userName" name="userName" id="userName" class="form-control" value="${employeeBean.userName}"/>
							</div>
							<div class="col-sm-4 form-group">
								<form:label path="attendanceId" for="attendanceId">Biomatric Id*</form:label>
								<br><span><b>${employeeBean.attendanceId}</b></span>
								<form:hidden path="attendanceId" name="attendanceId" id="attendanceId" class="form-control" />
							</div>
							<div class="col-sm-4 form-group">
								<label>Salutation*</label>
								<br><span>${employeeBean.salutation}</span>
								<form:hidden path="salutation" name="salutation" id="salutation" value="${employeeBean.salutation}"/>
						...
						<div class="row">
							<div class="col-sm-4 form-group">
								...
								<br><span>${employeeBean.firstName}</span>
								<form:hidden id="firstName" path="firstName" name="firstName" for="firstName" value="${employeeBean.firstName}" />
							...
							<div class="col-sm-4 form-group">
								...
								<br><span>${employeeBean.middleName}</span>
								<form:hidden id="middleName" path="middleName" name="middleName" for="middleName" value="${employeeBean.middleName}"/>
							...
							<div class="col-sm-4 form-group">
								...
								<br><span>${employeeBean.lastName}</span>
								<form:hidden id="lastName" path="lastName" name="lastName" for="lastName" value="${employeeBean.lastName}" />
        ...
        <div class="col-sm-12">
        				...
        				<div class="row">
							<div class="col-sm-6 form-group">
								...
								<br><span>${employeeBean.primaryEmailId}</span>
								<form:hidden path="primaryEmailId" name="primaryEmailId" id="primaryEmailId" value="${employeeBean.primaryEmailId}"/>
        ...
        <div class="col-sm-12">
        				<div class="row">
							<div class="col-sm-6 form-group">
								...
								<br><span>${employeeBean.joiningDate}</span>
								<form:hidden path="joiningDate" name="joiningDate" id="joiningDateId" class="form-control"/>
								<%-- <form:input type="text" path="joiningDate" name="joiningDate" id="joiningDateId" class="form-control" onkeydown="return false;"/> --%>
							</div>		
						<%-- <c:if test="${not empty employeeBean.middleName}">	
							<div class="col-sm-6 form-group">
								<label>Last Working Date</label>
								<br><span>${employeeBean.lastWorkingDate}</span>
        				...
        				<div class="row">
							<div class="col-sm-6 form-group">
								...
								<br><span>${employeeBean.baseLocation}</span>
							...
							<div class="col-sm-6 form-group">
								...
								<br><span>${employeeBean.department}</span>
        				...
        				<div class="row">
							<div class="col-sm-6 form-group">
								...
								<br><span>${employeeBean.designation}</span>
							...
							<div class="col-sm-6 form-group">
								<label>Role</label>
								<br><span>${employeeBean.role}</span>
						...
						<div class="row">
							<div class="col-sm-6 form-group">
								...
								<br><span>${sessionScope.reportingManager} (${employeeBean.reportingPerson})</span>
								<form:hidden path="reportingPerson" name="reportingPerson" id="reportingPerson" class="form-control" value="${employeeBean.reportingPerson}"/>
								<%-- <form:select path="reportingPerson" id="reportingPerson" name="reportingPerson" for="reportingPerson" placeholder="Reportee" maxlength="20" class="form-control">
								<form:option value='${employeeBean.reportingPerson}'>${employeeBean.reportingPerson}</form:option>
								</form:select> --%>
							</div>		
							<div class="col-sm-6 form-group">
								<label>HR Manager</label>
								<br><span>${sessionScope.hrManager} (${employeeBean.hrManager})</span>
								<form:hidden path="hrManager" name="hrManager" id="hrManager" class="form-control" value="${employeeBean.hrManager}"/>
								<%-- <form:select path="hrManager" id="hrManager" name="hrManager" for="hrManager" placeholder="HR Manager" maxlength="20" class="form-control">
						...
						<div class="row">
							<div class="col-sm-6 form-group">
								...
								<br><span>${employeeBean.accountUnit}</span>
							...
							<div class="col-sm-6 form-group">
								...
								<br><span>${employeeBean.policyGroupName}</span>
        ...
        <!-- <button type="button" id="submitEmpForm" class="btn btn-md btn-info pull-right" onclick="saveUserDetails();return false;">Save</button> -->
        	...
        	<div class="col-sm-12">
        		<div class=""row>
        			...
        			<c:if test="${empty employeeBean.empEducationList}">
						   <span style="color:red;font-weight:600;">No Data!</span>
					</c:if>
        		</div>
        	</div>
        </div>
       ...
       <div class="panel-body">
        	<div class="col-sm-12">
        		<div class=""row>
        			...
        			<c:if test="${empty employeeBean.empSkilltList}">
						   <span style="color:red;font-weight:600;">No Data!</span>
					</c:if>
        		</div>
        	</div>
       ...
       <div class="panel-body">
        	<div class="col-sm-12">
        		<div class=""row>
        			...
        			<c:if test="${empty employeeBean.empWorkHistoryList}">
						   <span style="color:red;font-weight:600;">No Data!</span>
					</c:if>
        		</div>
        	</div>
       ...
       <div class="panel-body">
        	<div class="col-sm-12">
        		<div class=""row>
        			...
        			<c:if test="${empty employeeBean.empAccountList}">
						   <span style="color:red;font-weight:600;">No Data!</span>
					</c:if>
        		</div>
        	</div>
