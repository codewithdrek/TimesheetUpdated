...
@keyframes spin {
  ...
  <tr>
    <td style="padding-left:7px;"><img src='<c:url value="/resources/images/logo.png" />' width="200px" height="70px" style="margin:5px;" /></td>
    <td>&nbsp;</td>
						...
						<div class="row">
							<div class="col-sm-6 col-sm-offset-3">
								<button name="register-submit" id="register-submit" tabindex="7" class="form-control btn-primary btn-md" value="Register Now">Register</button>
                                                    ...
                                                    <tr>
 <td><table width="auto" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr><!-- onmouseover="changeImage(this,'first');" onmouseout="normalImg(this,'first')" -->
<%-- <td><img src='<c:url value="/resources/images/icon-timesheet.png" />' /></td>
<td><img src='<c:url value="/resources/images/icon-leave.png" />' /></td>
<td><img src='<c:url value="/resources/images/icon-reimbresment.png" />' /></td>
<td><img src='<c:url value="/resources/images/icon-attendance.png" />' /></td> --%>
<td style="text-align:center;padding-left:5px;padding-right:5px;padding-bottom:50px;"><i class="fa fa-table" aria-hidden="true" style="font-size: 2em;padding:20px;color:#0080fe;"></i><br><strong>Timesheet<br>Management</strong></td>
<td style="text-align:center;padding-left:5px;padding-right:5px;padding-bottom:50px;"><i class="fa fa-bell" aria-hidden="true" style="font-size: 2em;padding:20px;color:#0080fe;"></i><br><strong>Leave<br>Management</strong></td>
<td style="text-align:center;padding-left:5px;padding-right:5px;padding-bottom:50px;"><i class="fa fa-scissors" aria-hidden="true" style="font-size: 2em;padding:20px;color:#0080fe;"></i><br><strong>Asset<br>Allocation</strong></td>
<td style="text-align:center;padding-left:5px;padding-right:5px;padding-bottom:50px;"><i class="fa fa-inr" aria-hidden="true" style="font-size: 2em;padding:20px;color:#0080fe;"></i><br><strong>User<br>Expenses</strong></td>
<td style="text-align:center;padding-left:5px;padding-right:5px;padding-bottom:50px;"><i class="fa fa-area-chart" aria-hidden="true" style="font-size: 2em;padding:20px;color:#0080fe;"></i><br><strong>Attendance<br>System</strong></td>
<td style="text-align:center;padding-left:5px;padding-right:5px;padding-bottom:50px;"><i class="fa fa-cogs" aria-hidden="true" style="font-size: 2em;padding:20px;color:#0080fe;"></i><br><strong>Report<br>Generation</strong></td>
  </tr>
</table>
</td>
                                        <td width="35">
 ...
 <table width="400" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
	...
	<td class="f-text" id="sdb2">Managed solution for enabling reduction in transition time through process automation.</td> 
  </tr>
</table>
</td>
  </tr>
